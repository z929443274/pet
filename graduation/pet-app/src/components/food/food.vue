<template>
  <div>
    <div class="foodTitle">宠物食物列表</div>
    <el-table :data="data" border>
      <el-table-column prop="name" label="商品名称" align='center' width="100"></el-table-column>
      <el-table-column prop="shape" label="商品形状" align='center' width="80"></el-table-column>
      <el-table-column prop="fit" label="适用犬种" align='center' width="80"></el-table-column>
      <el-table-column prop="taste" label="商品口味" align='center' width="80"></el-table-column>
      <el-table-column prop="packing" label="包装规格" align='center' width="100"></el-table-column>
      <el-table-column prop="impact" label="商品功用" align='center' width="120"></el-table-column>
      ...
      <el-table-column prop="count" label="售出数量" align='center' width="80"></el-table-column>
      <el-table-column prop="img" label="商品图片" align='center' width="120">
          <template slot-scope="scope">
              <img src="../../images/commodity/beef.jpg" alt="">
          </template>
      </el-table-column>
      <el-table-column label="操作" align='center'>
        <template slot-scope="scope">
          <el-button  type="text" size="small" @click="updateBtn(scope.row)">修改</el-button>
          <el-button  type="text" size="small" @click="delFoodAsync(scope.row._id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 显示修改信息 -->
    <el-dialog title="修改食物信息" :visible.sync="dialogFormVisible" :before-close="handleClose">
      <el-form :model="updateInfo" ref="updateInfo" style="width: 70%;margin:0 auto">
        ...
        <el-form-item label="商品形状" :label-width="formLabelWidth">
          <el-input v-model="updateInfo.shape" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="商品口味" :label-width="formLabelWidth">
          <el-input v-model="updateInfo.taste" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  computed: {
    ...
    methods: {
    ...mapActions(["getFoodByPageAsync", "delFoodAsync", "updateFoodAsync"]),
    ...
    updateSuccess(val) {
      this.$refs[val].validate(valid => {
        if (valid) {
          this.updateFoodAsync(this.updateInfo);
          this.$notify({
            title: "成功",
            message: "商品信息修改成功",
            type: "success"
